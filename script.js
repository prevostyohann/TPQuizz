    ...
    function ResultatDuScore() {
      ...
      if (nbDeQuestionsRepondues === data.questions.length) {
        ...
        boutonScoreRepYannick.addEventListener("click", () => {
          ...
          // Mettre :
          reponseYannick.innerHTML =
            "DÉMERDEZ VOUS !!! <br><br>Vous n'aviez qu'à retenir vos bonnes réponses !"; // Affiche Message Yannick
          ...
          setTimeout(function () {
            ...
            boutonAfficherscorenormal.innerHTML =
              "Si vous y tenez <br> Votre score est ici";
        ...
        listItem.addEventListener(
          ...
          (event) => {
            ...
            if (index === indexDelaBonneReponse) {
              ...
              list.children[indexDelaBonneReponse].style.backgroundColor =
                "rgb(142, 237, 155)"; // affichage de la bonne réponse en cas d'erreur
          ...
          { once: true }
        ); // Une seule sélection par réponse
